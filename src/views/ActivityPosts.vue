<template>
  ...
  <main class="max-w-4xl mx-auto px-6 pt-24 pb-20">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      <router-link v-for="post in activityPostsStore.posts" :key="post.id" :to="routeForArticle(post.id, post.defaultMode)"
    ...
    <p v-if="activityPostsStore.error && !activityPostsStore.hasData" class="text-center text-sm text-red-500 mt-6">
